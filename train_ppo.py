...
def train(batch_size, exp_name, actor_weights, critic_weights, debug):
    ...
    cfg_actor.reward_model_weights = cfg_critic.critic_weights
    ...
    reward_model = GPTRewardModel.from_checkpoint(
        cfg_critic, cfg_actor.reward_model_weights).cuda()
    # import pickle
    # import numpy as np
